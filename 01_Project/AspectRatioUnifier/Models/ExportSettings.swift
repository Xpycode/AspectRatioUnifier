...
struct ExportSettings: Equatable {
    ...
    func validateOverwriteMode(items: [ImageItem]) -> String? {
...
final class ExportProfileManager {
    ...
    private let userDefaultsKey = "AspectRatioUnifier.UserExportProfiles"
    ...
    private func loadProfiles() {
        ...
        do {
            ...
            AspectRatioUnifierLogger.storage.error("Failed to load export profiles: \(error.localizedDescription)")
        }
    }
    ...
    private func persist() {
        do {
            ...
            AspectRatioUnifierLogger.storage.error("Failed to save export profiles: \(error.localizedDescription)")
        }
    }
}
