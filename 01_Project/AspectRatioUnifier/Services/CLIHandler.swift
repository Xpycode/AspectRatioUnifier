...
struct CLIHandler {
    ...
    static func printHelp() {
        let help = """
        AspectRatioUnifier - Batch image cropping tool

        USAGE:
            AspectRatioUnifier [OPTIONS] <INPUT_FILES...>
        ...
        EXAMPLES:
            AspectRatioUnifier -t 50 -b 50 image.png
            AspectRatioUnifier -t 60 -b 34 -f jpg -q 85 *.png
            AspectRatioUnifier -t 100 -o ./output/ screenshots/*.png
            AspectRatioUnifier --grid-rows 3 --grid-cols 3 image.png
    ...
    static func printVersion() {
        ...
        print("AspectRatioUnifier version \(version) (\(build))")
    }
