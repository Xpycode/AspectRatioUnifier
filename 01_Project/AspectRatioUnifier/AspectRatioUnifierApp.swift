...
struct AspectRatioUnifierApp: App {
    ...
    private func copyActiveImageToClipboard() {
        ...
        do {
            ...
            AspectRatioUnifierLogger.ui.error("Failed to copy image: \(error.localizedDescription)")
        }
    }
    ...
    private func performExport(images: [ImageItem], to outputDirectory: URL, rename: Bool) async {
        do {
            ...
            AspectRatioUnifierLogger.export.error("Export failed: \(error.localizedDescription)")
        }
    }
}
